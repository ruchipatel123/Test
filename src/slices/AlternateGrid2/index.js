...
/**
 * @typedef {import("@prismicio/client").Content.AlternateGrid2Slice} AlternateGrid2Slice
 *
 * @typedef {import("@prismicio/react").SliceComponentProps<AlternateGrid2Slice>} AlternateGrid2Props
 *
 * @param {AlternateGrid2Props}
 */

const AlternateGrid2 = ({ slice }) => {
  return (
    <section
